...
export const initialPartners: Partner[] = [
  { id: 1, name: 'Distribuidor TechData', type: 'Distribuidor', contact: 'joao@techdata.com', phone: '(11) 98765-4321', status: 'Ativo', site: 'https://portal.techdata.com', login: 'user_techdata', password: '123', products: 'Licenças Microsoft, Hardware Dell, Cisco' },
  ...
  { id: 3, name: 'Distribuidor Ingram Micro', type: 'Distribuidor', contact: 'carlos@ingram.com', phone: '(21) 99999-8888', status: 'Inativo', site: 'https://www.ingrammicro.com.br', login: 'user_ingram', password: '456', products: 'HP, IBM, Lenovo' },
  ...
  { id: 5, name: 'Distribuidor Westcon', type: 'Distribuidor', contact: 'pedro@westcon.com', phone: '(31) 98765-1234', status: 'Ativo', site: 'https://www.westcon.com', login: 'user_westcon', password: '789', products: 'Palo Alto, F5, Juniper' },
...
export const initialRos: RO[] = [
    { id: 1, supplierId: 2, roNumber: 'AWS-12345', openDate: '2024-07-15', expiryDate: '2024-10-15', clientName: 'Empresa Alpha', product: 'AWS EC2 Instances', value: 25000 },
    { id: 2, supplierId: 4, roNumber: 'MS-ABC-678', openDate: '2024-06-20', expiryDate: '2024-09-20', clientName: 'Startup Beta', product: 'Microsoft 365 E5', value: 12000 },
];
