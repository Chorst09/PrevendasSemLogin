    ...
    return (
        <div className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <StatCard icon={<Briefcase className="w-6 h-6 text-primary" />} title="Orçamentos Ativos" value="75" subtext="+5% vs. mês passado" />
                ...
                <StatCard icon={<Users className="w-6 h-6 text-blue-500" />} title="Total de Parceiros" value={partners.length} subtext="Distribuidores e Fornecedores" />
